...
const sections: Section[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: 'Costo aterrizado (landed cost)',
        what: 'Calcula el costo real por unidad sumando el precio de compra + flete + otros costos, dividido entre el total de unidades.',
        how: 'Al crear o editar una compra, llena los campos "Flete/Envío" y "Otros costos" en la sección de costos adicionales. El costo aterrizado se calcula en tiempo real.',
        why: 'El precio de compra no siempre refleja el costo real. Si pagaste $10 por unidad pero $200 de flete para 50 piezas, el costo real es $14/pieza.',
        extra: [
          'Cálculo: (subtotal + flete + otros) / total unidades',
          'Se muestra en tiempo real al llenar los campos',
          'Útil para calcular márgenes correctos de ganancia',
        ],
      },
    ],
  },
  {
    ...
    features: [
      ...
      {
        title: 'Validación de límite de crédito',
        what: 'Si el cliente tiene un límite de crédito configurado y la venta lo excede, el sistema avisa antes de guardar.',
        how: 'Automático: al guardar una venta a crédito, se suman las deudas actuales del cliente + el nuevo monto. Si excede el límite, aparece una confirmación.',
        why: 'Evitar dar crédito más allá de lo acordado sin darse cuenta. El sistema avisa pero permite continuar si el vendedor lo aprueba.',
        extra: [
          'Solo aplica a ventas con status pendiente o parcial',
          'Calcula el saldo real: suma de (monto_total − monto_pagado) de ventas abiertas',
          'Muestra el exceso en pesos para facilitar la decisión',
          'El límite de crédito se configura en el perfil del cliente',
        ],
      },
    ],
  },
  ...
  {
    icon: '📑',
    module: 'Pedidos (Órdenes de Venta)',
    tagline: 'Flujo SAE: Cotización → Pedido → Venta. Gestiona compromisos antes de facturar.',
    color: 'bg-blue-50 text-blue-700 border-blue-200',
    features: [
      {
        title: 'Crear pedido desde cero',
        what: 'Documento previo a la venta que registra lo que el cliente quiere comprar, con precio y cantidad acordados.',
        how: 'Ve a Pedidos → "+". Selecciona cliente, fecha de entrega, agrega productos buscándolos por nombre/EAN/SKU y guarda como borrador o confirma.',
        why: 'Tener un compromiso formal con el cliente antes de surtir, para no modificar el inventario hasta que se entregue.',
        extra: [
          'Descuento automático según el porcentaje configurado en el cliente',
          'IVA 16% configurable por producto',
          'Cálculo automático de subtotal, IVA y total',
          'Campo de notas para instrucciones especiales de entrega',
        ],
      },
      {
        title: 'Flujo de estados del pedido',
        what: 'Cada pedido pasa por: Borrador → Confirmado → Surtido (o Cancelado).',
        how: 'Desde la lista, toca "Confirmar" para comprometer el pedido. Toca "Convertir a venta" cuando se surte.',
        why: 'Saber exactamente en qué etapa está cada pedido: si ya fue comprometido, si ya se entregó.',
      },
      {
        title: 'Convertir pedido a venta',
        what: 'Un pedido confirmado se puede convertir en venta con un solo toque. Se crea la venta y la remisión automáticamente.',
        how: 'En la lista, toca "Convertir a venta" en un pedido con status Confirmado. Se genera venta + remisión y el pedido queda como Surtido.',
        why: 'El flujo SAE completo: el pedido es el compromiso, la venta es la operación real. Sin duplicar captura.',
      },
    ],
  },
  {
    ...
    tagline: 'Flujo SAE: Orden Compra → Recibir Mercancía → Compra registrada.',
    color: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    features: [
      {
        title: 'Crear orden de compra',
        what: 'Documento que se envía al proveedor especificando qué se quiere comprar, cantidades y precios acordados.',
        how: 'Ve a Órdenes Compra → "+". Selecciona proveedor, fecha de entrega esperada, agrega productos y guarda como borrador o envía.',
        why: 'Tener un registro formal de lo que se pidió al proveedor antes de que llegue la mercancía.',
      },
      {
        title: 'Flujo de estados de la orden',
        what: 'Borrador → Enviada → Recibida parcial → Recibida (o Cancelada).',
        how: 'Toca "Marcar enviada" cuando se envía al proveedor. Al llegar la mercancía, toca "Recepción parcial" o "Recibir completo".',
        why: 'Saber qué órdenes están en camino, cuáles llegaron incompletas y cuáles están cerradas.',
      },
      {
        title: 'Recepción genera compra automáticamente',
        what: 'Al registrar la recepción (parcial o completa) se crea automáticamente un registro de compra.',
        how: 'Toca "Recibir completo" o "Recepción parcial". Se crea la compra con los datos de la orden y la orden queda como recibida.',
        why: 'Flujo SAE: la orden es el pedido al proveedor, la compra es la entrada real al sistema. Sin doble captura.',
      },
    ],
  },
  {
  ...
  {
    icon: '🎯',
    module: 'Controles SAE',
    tagline: 'Expediente de cliente, alertas de caducidad y trazabilidad de lotes',
    color: 'bg-violet-50 text-violet-700 border-violet-200',
    features: [
      {
        title: 'Expediente del cliente',
        what: 'Vista consolidada de la situación comercial de un cliente: crédito usado, pedidos activos y últimas ventas.',
        how: 'Ve a Clientes → toca un cliente → pestaña "Expediente". Se muestra la barra de crédito, pedidos abiertos y últimas 5 ventas.',
        why: 'Antes de vender, el vendedor puede revisar de un vistazo si el cliente está al corriente, si tiene pedidos pendientes y cuánto crédito le queda.',
        extra: [
          'Barra de crédito: verde (<70%), ámbar (70-90%), rojo (≥90%) del límite usado',
          'Lista de pedidos activos con status y monto',
          'Historial de últimas 5 ventas con monto y status de pago',
        ],
      },
      {
        title: 'Alertas de lotes por caducar',
        what: 'El dashboard muestra automáticamente qué lotes de inventario están por caducar en los próximos 30 días.',
        how: 'Automático: entra al Dashboard. Si hay lotes próximos a caducar, aparece una tarjeta roja con el número de lote, producto, cantidad y fecha de caducidad.',
        why: 'Evitar pérdidas por mercancía caducada que no se notó a tiempo.',
        extra: [
          'Ventana de alerta: productos que caducan en los próximos 30 días',
          'Muestra número de lote, producto, cantidad disponible y fecha exacta',
          'Se actualiza cada vez que entras al dashboard',
        ],
      },
      {
        title: 'Inventario por lotes',
        what: 'Cada registro de inventario puede tener múltiples lotes con su propia cantidad y fecha de caducidad.',
        how: 'Al registrar o editar un producto en Inventario, puedes agregar lotes con número de lote, cantidad y fecha de caducidad.',
        why: 'Trazabilidad por lote: saber exactamente qué se compró cuándo, para respetar FIFO y controlar caducidades.',
      },
    ],
  },
  {
